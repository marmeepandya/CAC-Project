...
├── Presentation & Report/                        # Presentation materials and written reports
...
├── framing_annotation_step_4.ipynb               # Final validation on the random sample
│
├── framing_annotation_step3_CoT +FSE.ipynb       # Step 3 with chain-of-thought and few-shot examples
├── framing_step3_FSE_new250.ipynb                 # Step 3 few-shot workflow for 250 new observations
├── framing_step3_llms_test.ipynb                  # Testing of LLM configurations
├── framing_step3_model_routed.ipynb               # Model-routed Step 3 workflow
├── framing_step3_new250_CoT+FSE.ipynb             # Step 3 CoT and FSE workflow for 250 new observations
│
...
└── wget-log                                       # Log generated by wget
```
